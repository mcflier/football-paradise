      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <Card className="border-slate-700 bg-slate-800/50 backdrop-blur-sm">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl font-bold text-white">Digital Football Paradise</CardTitle>
            <CardDescription className="text-slate-400">
              The ultimate Madden league management platform
            </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col items-center space-y-6">
            <div className="relative w-32 h-32 mb-4">
              ...
              <div className="absolute inset-1 rounded-full bg-slate-800 flex items-center justify-center">
                <span className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-purple-400">DFP</span>
              </div>
            </div>
